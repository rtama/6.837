...
public:
    ...
    void drawJoint(const Camera& camera, Joint* joint, MatrixStack* stack);
    ...
    void drawRecurseSkeleton(const Camera& camera, Joint* joint, MatrixStack* stack);
    ...
    void recurseBindWorldToJointTransforms(Joint* joint, MatrixStack* stack);

    // 2.3.2. Implement this method to compute a per-joint transform from
    // joint space to world space in the CURRENT POSE.
    void updateCurrentJointToWorldTransforms();
    void recurseUpdateCurrentJointToWorldTransforms(Joint* joint, MatrixStack* stack);
